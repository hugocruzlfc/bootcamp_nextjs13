...
export default function ReservationCard({
  ...
  const [day, selectedDay] = useState(new Date().toISOString().split("T")[0]);
  console.log(data);
            ...
            {data.map((time) => {
              return time.available ? (
                <Link
                  ...
                  className="bg-red600 cursor-pointer p-2 w-24 text-center tex-white mb-3 rounded mr-3"
                >
